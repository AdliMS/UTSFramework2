...
<body class="flex flex-col justify-between items-center min-h-[100vh] p-0 mx-0 ">

  <nav x-data="{ isOpen: false }" class="bg-[#FFB0B0] w-[100vw]">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/kenalan" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Kenalan</a>
      </div>
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Adli Suryadin</div>
            <div class="text-sm font-medium leading-none text-gray-400">adli@example.com</div>
          </div>
        </div>
  ...
  <footer class="flex justify-center items-center bg-[#FFB0B0] h-16 w-full">
    <p class="text-amber-950 text-sm ">Adli Imam Suryadin &copy; 2024, Universitas Mulawarman</p>
</footer>
