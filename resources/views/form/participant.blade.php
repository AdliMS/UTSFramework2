        ...
        <h1 id="heading" class=" text-4xl font-semibold text-slate-500 pb-3 border-b border-slate-200 order-1 text-center">Form Registrasi</h1>
          ...
          <form class="flex flex-col flex-grow justify-center gap-4 order-3" action="/participant-form/{{ $event->event_id }}" method="post">
            @csrf
                ...
                <input disabled id="name" name="event" type="text" class="bg-slate-100 rounded-md h-12 p-5 placeholder:text-slate-500 hover:bg-slate-200 transition-all focus:outline-none" placeholder="{{ $event->event_name }}">            
                <input id="name" name="name" type="text" class="bg-slate-100 rounded-md h-12 p-5 placeholder:text-slate-500 hover:bg-slate-200 transition-all focus:outline-none" placeholder="Nama Lengkap">
                <input id="desc" name="email" type="email" class="bg-slate-100 rounded-md h-12 p-5 placeholder:text-slate-500 hover:bg-slate-200 transition-all focus:outline-none" placeholder="Email">
                <input id="date" name="phone_number" type="text" class="bg-slate-100 rounded-md h-12 p-5 placeholder:text-slate-500 hover:bg-slate-200 transition-all focus:outline-none" placeholder="Nomor Handphone">        
